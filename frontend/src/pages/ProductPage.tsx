                ...
                <div className="space-y-4 pt-2">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-1">
                    <button
                      ...
                      className="w-full bg-white hover:bg-blue-50 text-blue-600 border-2 border-blue-600 text-base font-bold py-3.5 rounded-xl transition-all flex items-center justify-center gap-2 active:scale-[0.99] shadow-xs cursor-pointer"
                    >
                    ...
                    <button 
                      ...
                      className="w-full bg-blue-600 hover:bg-blue-700 active:scale-[0.99] text-white text-base font-bold py-3.5 rounded-xl transition-all shadow-md shadow-blue-500/25 flex items-center justify-center gap-2 cursor-pointer"
                    >
